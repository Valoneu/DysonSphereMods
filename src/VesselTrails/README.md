...
| :--- | :--- |
| **1.1.0** | **UI & Stats Overhaul.** Added persistent Logistics Window with trip tracking (/min, Load, Total). Implemented "Bundle" rendering for multi-material routes. DSP-themed UI. |
