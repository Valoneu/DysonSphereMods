...
## Contact 
is in DSP discord Valoneu#8617 in modding channel, or just add me
...
v1.1.1
1. Changed config so it accepts value between 0.01 - 100

v1.1.0
1. Changed so it works even for normal tech tree and not only for upgrades

v1.0.4
1. Idk man i just hope it works this time
